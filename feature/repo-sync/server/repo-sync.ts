...
import { getGithubApp } from "../../github/utils/github-app";
import { getPineconeIndex } from "../../pinecone/client";
import { CodeChunk } from "../../reviews/types/review";
...
export async function getRepoSyncStatus(repoFullNames: string[]) {
